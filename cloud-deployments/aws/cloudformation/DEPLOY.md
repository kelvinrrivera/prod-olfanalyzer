...
5. Use the file `cloudformation_create_olfanalyzer.json` as your JSON template.
...
```
[+] Running 2/2
 ⠿ Network docker_olfanalyzer  Created 
 ⠿ Container olfanalyzer       Started  
```
