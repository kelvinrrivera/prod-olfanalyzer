...
const doc = {
  info: {
    version: "1.0.0",
    title: "OLFANALYZER Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your OLFANALYZER instance. UI supplied by Swagger.io.",
  },
