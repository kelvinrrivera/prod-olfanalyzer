  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "OLFANALYZER | Your AI Fragrance Wizard",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://olfanalyzer.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      },
      {
        ...
        props: {
          property: "og:image",
          content:
            "https://raw.githubusercontent.com/Mintplex-Labs/olfanalyzer/master/images/promo.png",
        },
      },
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://olfanalyzer.com" },
      },
      {
        tag: "meta",
        props: {
    ...
    if (customTitle === null && faviconURL === null) {
      ...
      this.#customConfig = [
        ...
        },
        {
          ...
          content:
            customTitle ??
            "OLFANALYZER | Your AI Fragrance Wizard",
        },
      ];
    }
