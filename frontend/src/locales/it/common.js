const TRANSLATIONS = {
  ...
  general: {
    ...
    message: {
      ...
      save: "Salva messaggi",
      heading: "Spiegami",
      body: "i vantaggi di OLFANALYZER",
    },
    pfp: {
  ...
  appearance: {
    ...
    message: {
      ...
      user: "utente",
      message: "messaggio",
      assistant: "Assistente chat OLFANALYZER",
  ...
  api: {
    title: "Chiavi API",
    description:
      "Le chiavi API consentono al titolare di accedere e gestire in modo programmatico questa istanza OLFANALYZER.",
  ...
  llm: {
    ...
    description:
      "Queste sono le credenziali e le impostazioni per il tuo provider di chat e embedding LLM preferito. È importante che queste chiavi siano aggiornate e corrette, altrimenti OLFANALYZER non funzionerà correttamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "L'utilizzo del modello whisper locale su macchine con RAM o CPU limitate può bloccare OLFANALYZER durante l'elaborazione di file multimediali.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "L'embedding è il processo di trasformazione del testo in vettori. Queste credenziali sono necessarie per trasformare i file e i prompt in un formato che OLFANALYZER può utilizzare per l'elaborazione.",
    provider: {
      title: "Provider di embedding",
      description:
        "Non è richiesta alcuna configurazione quando si utilizza il motore di embedding nativo di OLFANALYZER.",
    },
  },
  ...
  vector: {
    ...
    description:
      "Queste sono le credenziali e le impostazioni per il funzionamento della tua istanza OLFANALYZER. È importante che queste chiavi siano aggiornate e corrette.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Proteggi la tua istanza OLFANALYZER con una password. Se la dimentichi, non esiste un metodo di recupero, quindi assicurati di salvare questa password.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Questa è la tua configurazione per il modo in cui i provider terzi connessi e OLFANALYZER gestiscono i tuoi dati.",
    llm: "Selezione LLM",
