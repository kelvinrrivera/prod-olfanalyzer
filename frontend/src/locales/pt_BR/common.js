const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1: "Bem-vindo ao OLFANALYZER, seu assistente de inteligência artificial especializado na criação de fragrâncias. Projetado para profissionais da perfumaria, o OLFANALYZER combina criatividade e inovação para otimizar suas fórmulas e melhorar seus resultados. Sem taxas ocultas: apenas um foco dedicado em potencializar o seu talento.",
    part2: "Passos para criar fórmulas de perfume:",
    part3: "1. **Para começar, selecione seu assistente**: Use a barra lateral para escolher o assistente que melhor se adapte às suas necessidades específicas de formulação.",
    part4: "2. **Defina seus objetivos**: Descreva de forma clara e detalhada o tipo de fragrância que deseja criar. Inclua notas aromáticas, as emoções que deseja evocar e o contexto de uso.",
    part5: "3. **Ajuste as opções**: Use o assistente para gerar uma fórmula inicial. Se necessário, você pode fazer ajustes ou solicitar novas recomendações com base em suas necessidades.",
    part6: "4. **Otimize a composição**: Consulte as regulamentações IFRA, tendências de mercado e preços dos ingredientes para garantir que sua fórmula atenda aos padrões de qualidade e rentabilidade.",
    part7: "5. **Imprima e teste**: Baixe a fórmula no formato PDF ou DOC, realize testes em laboratório e ajuste os detalhes finais para aperfeiçoar sua fragrância.",
    part8: "Com o OLFANALYZER, o processo de criação é simples, inovador e eficiente! Explore todas as suas possibilidades e eleve suas criações a um novo patamar.",
    contact: "Precisa de ajuda? Entre em contato conosco para suporte.",
    },
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do OLFANALYZER",
    },
    pfp: {
  ...
  appearance: {
    ...
    message: {
      ...
      user: "usuário",
      message: "mensagem",
      assistant: "Assistente de Chat OLFANALYZER",
  ...
  api: {
    title: "Chaves API",
    description:
      "As chaves API permitem que o titular acesse e gerencie programaticamente esta instância do OLFANALYZER.",
  ...
  llm: {
    ...
    description:
      "Estas são as credenciais e configurações para seu provedor preferido de chat e incorporação de LLM. É importante que essas chaves estejam atualizadas e corretas, caso contrário, o OLFANALYZER não funcionará corretamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo whisper local em máquinas com RAM ou CPU limitados pode travar o OLFANALYZER ao processar arquivos de mídia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "A incorporação é o processo de transformar texto em vetores. Essas credenciais são necessárias para transformar seus arquivos e prompts em um formato que o OLFANALYZER possa usar para processar.",
    provider: {
      title: "Provedor de Incorporação",
      description:
        "Não é necessária configuração ao usar o mecanismo de incorporação nativo do OLFANALYZER.",
    },
  },
  ...
  vector: {
    ...
    description:
      "Estas são as credenciais e configurações de como sua instância do OLFANALYZER funcionará. É importante que essas chaves estejam atualizadas e corretas.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Proteja sua instância do OLFANALYZER com uma senha. Se você esquecer esta senha, não há método de recuperação, então certifique-se de salvar esta senha.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Esta é a sua configuração de como os provedores de terceiros conectados e o OLFANALYZER tratam seus dados.",
    llm: "Seleção de LLM",
