const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1: "Welcome to OLFANALYZER, your AI assistant specialized in fragrance creation. Designed for perfumery professionals, OLFANALYZER combines creativity and innovation to optimize your formulas and improve your results. No hidden fees: just a dedicated focus on enhancing your talent.",
    part2: "Steps to create perfume formulas:",
    part3: "1. **To start, select your assistant**: Use the sidebar to choose the assistant that best fits your specific formulation needs.",
    part4: "2. **Define your objectives**: Clearly and thoroughly describe the type of fragrance you want to create. Include aromatic notes, the emotions you want to evoke, and the context of use.",
    part5: "3. **Adjust the options**: Use the assistant to generate an initial formula. If needed, you can make adjustments or request new recommendations based on your requirements.",
    part6: "4. **Optimize the composition**: Consult IFRA regulations, market trends, and ingredient prices to ensure your formula meets quality and profitability standards.",
    part7: "5. **Print and test**: Download the formula in PDF or DOC format, perform laboratory tests, and fine-tune the details to perfect your fragrance.",
    part8: "With OLFANALYZER, the creation process is simple, innovative, and efficient! Explore all its possibilities and take your creations to the next level.",
    contact: "Need help? Contact us for support.",
  },
  ...
  general: {
    ...
    message: {
      ...
      body: "the benefits of OLFANALYZER",
    },
    pfp: {
  ...
  appearance: {
    ...
    message: {
      ...
      user: "user",
      message: "message",
      assistant: "OLFANALYZER Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this OLFANALYZER instance.",
  ...
  llm: {
    ...
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. Its important these keys are current and correct or else OLFANALYZER will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall OLFANALYZER when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which OLFANALYZER can use to process.",
    provider: {
      title: "Embedding Provider",
      description:
        "There is no set up required when using OLFANALYZER's native embedding engine.",
    },
  },
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your OLFANALYZER instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protect your OLFANALYZER instance with a password. If you forget this there is no recovery method so ensure you save this password.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and OLFANALYZER handle your data.",
    llm: "LLM Selection",
