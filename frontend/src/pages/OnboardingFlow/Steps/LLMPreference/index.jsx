...
const DESCRIPTION =
  "OLFANALYZER can work with many LLM providers. This will be the service which handles chatting.";
...
const LLMS = [
  ...
  },
  {
    ...
    description:
      "Use a downloaded custom Llama model for chatting on this OLFANALYZER instance.",
  },
];
...
export default function LLMPreference({
  ...
  const handleSubmit = async (e) => {
    ...
    // Default to OLFANALYZER embedder and LanceDB
